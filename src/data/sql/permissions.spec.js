...
describe('data/sql/permissions', () => {
    describe('convertDataType', () => {
        it('handles unknown values by returning `undefined`', () => {
            const data = [{js: 'notPublic', sql: 'not0'}, {js: 'notStaff', sql: 'not1'}, {js: 'notAdmin', sql: 'not3'}];
        ...
        it('converts DATA_LEVELS correctly', () => {
            const data = [{js: 'public', sql: 0}, {js: 'staff', sql: 1}, {js: 'admin', sql: 2}, {js: 'debug', sql: 3}];
            data.forEach((testData) => {
                //NOTE: 'dataViewLevel' is a DATA_LEVELS field
        ...
        it('converts OWNERSHIPS correctly', () => {
            const data = [{js: null, sql: 0}, {js: 'own', sql: 1}, {js: 'all', sql: 2}];
            data.forEach((testData) => {
